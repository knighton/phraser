#ifndef CC_BASE_SEQUENCE_DETECTION_SEQUENCE_MATCH_H_
#define CC_BASE_SEQUENCE_DETECTION_SEQUENCE_MATCH_H_
...
#endif  // CC_BASE_SEQUENCE_DETECTION_SEQUENCE_MATCH_H_
