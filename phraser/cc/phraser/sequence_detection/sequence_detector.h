#ifndef CC_PHRASER_SEQUENCE_DETECTION_SEQUENCE_DETECTOR_H_
#define CC_PHRASER_SEQUENCE_DETECTION_SEQUENCE_DETECTOR_H_
...
#include "cc/phraser/sequence_detection/sequence_match.h"
